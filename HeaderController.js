...
function Start() {
    ...
    document.getElementById("JS_HEADER").style.height = HeaderSize;
}
...
function ResizeOnScroll() {
    ...
    /** Set opacitys */
    nameElement.style.opacity = (1 - clamp((CurrentScrollY) / StartingSize * 1.2, 0, 1));
    console.log(nameElement.style.opacity);
    //console.log(nameElement.style.opacity);
}
